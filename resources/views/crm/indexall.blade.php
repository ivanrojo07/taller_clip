                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="table table-striped table-bordered table-hover" style = "margin-bottom: 0px">
                            ...
                            <tr title="Has Click Aquì para ver o modificar" style="cursor: pointer" data-toggle="modal" data-target="#myModal" class="active tupla">
                                ...
                                <input type="hidden" name="id_cliente" value="{{ $crm->cliente->id }}">
                                <input type="hidden" name="nombre" value="{{ $crm->cliente->nombre }}">
                                <input type="hidden" name="ap" value="{{ $crm->cliente->apellidopaterno }}">
                                <input type="hidden" name="am" value="{{ $crm->cliente->apellidomaterno }}">
                                <input type="hidden" name="razon" value="{{ $crm->cliente->razonsocial }}">
